        ...
        <div class="col-12">
          <div class="nav-align-top mb-4">
            ...
            <div class="tab-content">
              @foreach($categories as $index => $category)
                <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}" id="{{$category->title}}" role="tabpanel">
                  <div class="container">
                    <div class="row">
                      @php
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 d-flex mb-3">
                          <div class="card border-0 text-white w-100 h-100 position-relative"
                            ...
                            <div class="d-flex flex-column justify-content-between h-100 text-center">
                              <!-- Üstteki başlık -->
                              <div class="d-flex justify-content-center" style="margin-bottom: 1.5vh;padding-top: 0.8vh">
